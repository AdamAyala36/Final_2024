...
The information to play close attention to among all of these results is the output of the Fisher's Exact test. The p-value displayed above is extremely small at 2.2e-16. Seeing this number means that these results are not likely to occur by chance.
...
The odds ratio of the males with vaccines vs those with placebos has a ratio greater than 70 maeaning we have a effective vaccine for males. 
